...
/******/ 			return "" + chunkId + "" + {"42":"839908a035fc213bf44d","273":"569af7784432092091a5"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "emoji-art-generator:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkemoji_art_generator"] = self["webpackChunkemoji_art_generator"] || [];
...
;// CONCATENATED MODULE: ./node_modules/picmo/dist/index.js
var O = (i, e, t) => {
  if (!e.has(i))
...
class Fs extends (/* unused pure expression or super */ null && (xe)) {
  constructor() {
...
var emojiDataPath = "emojibase-data/".concat(navigator.language, "/data.json");
var messagesPath = "emojibase-data/".concat(navigator.language, "/messages.json");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return __webpack_require__.e(/* import() */ 273).then(__webpack_require__.t.bind(__webpack_require__, 273, 19));
          case 2:
            emojiData = _context.sent;
            _context.next = 5;
            return __webpack_require__.e(/* import() */ 42).then(__webpack_require__.t.bind(__webpack_require__, 42, 19));
          case 5:
...
var heightInput = document.querySelector("#stats input[name=height]");
var widthInput = document.querySelector("#stats input[name=width]");
var board = document.querySelector("#board");
var currentSelection = document.querySelector("#current-selection span");
var resizeBtn = document.querySelector("#resize");
var copyBtn = document.querySelector("#copy");
var toPicBtn = document.querySelector("#to-picture");

// The picker must have a root element to insert itself into
var sideToolSet = document.querySelector("#side-tool-set");
...
var msg = encodeURIComponent("I created an emoji art\n".concat(currentText));
var title = encodeURIComponent(document.querySelector("title").textContent);
fb.href = "https://www.facebook.com/share.php?u=".concat(src_link);
linkedIn.href = "https://www.linkedin.com/sharing/share-offsite/?url=".concat(src_link);
reddit.href = "http://www.reddit.com/submit?url=".concat(src_link, "&title=").concat(title);
...
function createBoard(height, width) {
  ...
  board.style.setProperty("--size", "".concat(90 / width, "vmin"));
  for (var i = 0; i < height; i++) {
    for (var j = 0; j < width; j++) {
...
var setEmojiToTarget = function setEmojiToTarget(e) {
  ...
  twitter.href = "http://twitter.com/share?&url=".concat(src_link, "&text=").concat(msg, "&hashtags=emoji,emojiart");
};
var openEmojiPicker = function openEmojiPicker() {
  sideToolSet.classList.add("shown");
};
var closeEmojiPicker = function closeEmojiPicker() {
  sideToolSet.classList.remove("shown");
};
var setCurrentEmoji = function setCurrentEmoji(emoji) {
...
body.addEventListener("click", function (e) {
  if (e.target.closest("#side-tool-set") === sideToolSet || e.target.closest("#current-selection span") === currentSelection) {
    return;
  }
  closeEmojiPicker();
});
...
function _copyText() {
  _copyText = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            _navigator = navigator, clipboard = _navigator.clipboard; // console.log("copy!");
            _context2.next = 4;
            return clipboard.writeText(currentText);
          case 4:
          case "end":
